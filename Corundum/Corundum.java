...
public class Corundum {
     ...
     *            (usually the Overworld); leave it blank to specify the default world name, "world"</li> <li>
     *            <tt>--gui-enabled, -g</tt> to enable the Corundum Gui, which replaces the default Minecraft Server Gui. <tt>--mc-gui, -mc-g</tt> to use the default Minecraft
     *            Server Gui</li> */

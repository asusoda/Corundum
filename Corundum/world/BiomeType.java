...
public class BiomeType extends IDedType<BiomeType> {
    public static final BiomeType OCEAN = new BiomeType(), PLAINS = new BiomeType(), DESERT = new BiomeType(), EXTREME_HILLS = new BiomeType(), FOREST = new BiomeType(),
            TAIGA = new BiomeType(), SWAMPLAND = new BiomeType(), RIVER = new BiomeType(), NETHER = new BiomeType(), END = new BiomeType(), FROZEN_OCEAN = new BiomeType(),
            FROZEN_RIVER = new BiomeType(), ICE_PLAINS = new BiomeType(), ICE_MOUNTAINS = new BiomeType(), MUSHROOM_ISLAND = new BiomeType(),
            MUSHROOM_ISLAND_SHORE = new BiomeType(), BEACH = new BiomeType(), DESERT_HILLS = new BiomeType(), FOREST_HILLS = new BiomeType(), TAIGA_HILLS = new BiomeType(),
            EXTREME_HILLS_EDGE = new BiomeType(), JUNGLE = new BiomeType(), JUNGLE_HILLS = new BiomeType(), JUNGLE_HILLS_EDGE = new BiomeType(), DEEP_OCEAN = new BiomeType(),
            STONE_BEACH = new BiomeType(), COLD_BEACH = new BiomeType(), BIRCH_FOREST = new BiomeType(), BIRCH_FOREST_HILLS = new BiomeType(),
            ROOFED_FOREST = new BiomeType(), COLD_TAIGA = new BiomeType(), COLD_TAIGA_HILLS = new BiomeType(), MEGA_TAIGA = new BiomeType(),
            MEGA_TAIGA_HILLS = new BiomeType(), EXTREME_HILLS_PLUS = new BiomeType(), SAVANNA = new BiomeType(), SAVANNA_PLATEAU = new BiomeType(), MESA = new BiomeType(),
            MESA_PLATEAU = new BiomeType(), MESA_PLATEAU_F = new BiomeType(), SUNFLOWER_PLAINS = new BiomeType(129), DESERT_M = new BiomeType(),
            EXTREME_HILLS_M = new BiomeType(), FLOWER_FOREST = new BiomeType(), TAIGA_M = new BiomeType(), SWAMPLAND_M = new BiomeType(), ICE_PLAINS_SPIKES = new BiomeType(
                    140), JUNGLE_M = new BiomeType(149), JUNGLE_EDGE_M = new BiomeType(151), BIRCH_FOREST_M = new BiomeType(155), BIRCH_FOREST_HILLS_M = new BiomeType(),
            ROOFED_FOREST_M = new BiomeType(), COLD_TAIGA_M = new BiomeType(), MEGA_SPRUCE_TAIGA = new BiomeType(160), MEGA_SPRUCE_TAIGA_HILLS = new BiomeType(),
            EXTREME_HILLS_PLUS_M = new BiomeType(), SAVANNAH_M = new BiomeType(), SAVANNAH_PLATEAU_M = new BiomeType(), MESA_BRYCE = new BiomeType(),
            MESA_PLATEAU_F_M = new BiomeType(), MESA_PLATEAU_M = new BiomeType();
    ...
    public/* TODO: change return type to AnimalType when we have AnimalTypes */MobType[] getAnimals() {
         ...
         * represent the kind of entity they will spawn, but since all their names will be obfuscated during runtime, we'll probably have to add a parameter to each EntityType
         * for the Minecraft class that they represent */
        return null;
    }

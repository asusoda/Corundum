...
/** This class includes a variety of methods that will be called within all {@link CorundumListener}s registered with Corundum. Each method's name and arguments describe an
 ...
 * 
 * @author REALDrummer */
public abstract class CorundumListener {
    // event handling
    ...
    // abstract getters
    public abstract CorundumPlugin getPlugin();
}
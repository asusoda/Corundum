...
public interface Matchable<T extends Matchable<T>> {
    default public int compareToItem(T comparable) {
        return compare(getSortPriorities(), comparable.getSortPriorities());
    }
    ...
    default public int matchTo(Object... match_parameters) {
        return match(getSortPriorities(), match_parameters);
    }
